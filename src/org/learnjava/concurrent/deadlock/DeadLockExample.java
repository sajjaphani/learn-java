...
/**
 * This programs demonstrates the occurrence of a dead lock when two threads are
...
public class DeadLockExample {
	...
	static class Task2 implements Runnable {
		...
		public void run() {
			synchronized (sharedResource2) {
				System.out.println("Task 2 Acquired lock on Shared Resource 2");
				System.out.println("Task 2 Tries to acquire lock on Shared Resource 1");
				synchronized (sharedResource1) {
